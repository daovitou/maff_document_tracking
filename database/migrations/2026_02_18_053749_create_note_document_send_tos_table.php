...
return new class extends Migration
{
    ...
    {
        Schema::create('note_document_send_tos', function (Blueprint $table) {
            $table->uuid('id')->primary();
            $table->boolean('is_personel')->nullable()->default(false);
            $table->uuid('note_document_id')->nullable()->constrained("note_documents", "id")->cascadeOnDelete("set null");
    ...
    {
        Schema::dropIfExists('note_document_send_tos');
    }
};
