...
new #[Layout('layouts::admin.app'), Title('Create Document')] class extends Component {
    ...
    public function save()
    {
        ...
        foreach ($this->attachments as $index => $file) {
            ...
            $storedDoc->document_type = 'be document';
...
<div>
    <flux:heading size="xl" level="1">{{ __('New BE Document') }}</flux:heading>
                    ...
                    <td colspan="5" class="text-center">
                        ...
                        <flux:modal name="new_reciever" class="w-xl text-left">
                            ...
                            <flux:field class="mt-4">
                                ...
                                <flux:error name="reciever.respect_at" />
