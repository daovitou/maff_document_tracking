...
new #[Layout('layouts::admin.app'), Title('Create User')] class extends Component {
    ...
    public function messages()
    {
        return [
            ...
            'user.gd_id.required' => __('General Department is required'),
        ];
    }
...
<div>
    <flux:heading size="xl" level="1">{{ __('New User') }}</flux:heading>
    ...
    <form wire:submit.prevent="save" enctype="multipart/form-data"
        ...
        <div class="flex-1 space-y-6">
            ...
            <flux:field class="mt-4">
                ...
                <x-searchable-select wire:model.live="user.gd_id" icon="building-office-2"
