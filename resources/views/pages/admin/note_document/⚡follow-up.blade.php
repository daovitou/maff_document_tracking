...
new #[Layout('layouts::admin.app'), Title('Create Document')] class extends Component {
    ...
    public function docs()
    {
        ...
        return NoteDocument::search($this->search)->where('status', 'កំពុងរងចាំ')->where('send_at', '<', $threeDaysAgo)->orderBy($this->sortField, $this->sortDirection)->paginate($this->perPage);
    }
