...
new #[Layout('layouts::admin.app'), Title('Create Document')] class extends Component {
    ...
    public function removeOldFile($id)
    {
        ...
        //     'type' => 'success',
        // ]);
        return $this->redirectIntended(route('admin.note-document.edit', $this->document->id), true);
    }
...
<div>
    <flux:heading size="xl" level="1">{{ __('Edit Note Documentation') }}</flux:heading>
                        ...
                        <flux:modal name="new_reciever" class="w-xl text-left">
                            <flux:field class="mt-4">
                                ...
                                <div class="flex flex-row gap-3 items-center justify-center">
                                    ...
                                    <div class="relative">
                                        <input type="date" id="sendDateInput" class="w-0 h-0 absolute"
                                            wire:model.live="reciever.send_at">
                                        <button type="button"
                                            onclick="document.getElementById('sendDateInput').showPicker()">
                                            <flux:icon.calendar />
                                        </button>
                                    </div>
