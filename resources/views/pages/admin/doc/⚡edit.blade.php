...
new #[Layout('layouts::admin.app'), Title('Documentation | Edit Document')] class extends Component {
    //
    ...
    {
        if (!Gate::forUser(auth('admin')->user())->allows('edit-document')) {
            abort(403);
        }
    }
    ...
    public function mount($id)
    {
        ...
        $this->send_at = Carbon::parse($this->document->send_at)->format('Y-m-d');
    }
