...
new #[Layout('layouts::admin.app'), Title('Documentation | Follow Up Document List')] class extends Component {
    //
    ...
    public function docs()
    {
        ...
        return Document::search($this->search)->where('status', 'កំពុងរងចាំ')->where('article_at', '<', $threeDaysAgo)->orderBy($this->sortField, $this->sortDirection)->paginate($this->perPage);
    }
...
<div>
    ...
    <flux:text class="mb-6 mt-2 text-xl">{{ __('Follow Up Document List') }}</flux:text>
