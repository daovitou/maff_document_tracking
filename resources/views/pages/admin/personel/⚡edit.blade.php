...
new #[Layout('layouts::admin.app'), Title('Personel | Edit Personel')] class extends Component {
    //
    public $personel;
    public function mount($id)
    {
        $this->personel = Personel::find($id);
    }
    ...
    {
        $this->validate();
        $this->personel->updated_by = Auth::guard('admin')->user()->id;
        $this->personel->save();
