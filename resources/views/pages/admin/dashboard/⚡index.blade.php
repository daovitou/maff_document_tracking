...
<div>
    ...
    <div
        class="relative border border-zinc-200 px-4 pb-4 pt-8 rounded-xl shadow grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8">
        ...
        <div class="relative bg-green-100/80 border border-green-300 rounded-lg h-36 overflow-clip p-4">
            ...
            <div>
                ...
                <span class="block font-bold text-6xl text-green-600">{{ $this->allNoteDocs }}</span>
        ...
        <div class="relative bg-amber-100/80 border border-amber-300 rounded-lg h-36 overflow-clip p-4">
            ...
            <div>
                <span class="block font-semibold text-lg">{{ __('Pending Documents') }}៖</span>
                <span class="block font-bold text-6xl text-amber-600">{{ $this->docs }}</span>
                <flux:link href="{{ route('admin.note-document.pending') }}" variant="subtle" class="text-sm"
                    wire:navigate>
                    {{ __('View Documents') }}</flux:link>
            </div>
        </div>
        <div class="relative bg-red-100/80 border border-red-300 rounded-lg h-36 overflow-clip p-4">
            ...
            <div>
                <span class="block font-semibold text-lg">{{ __('Follow Up Documents') }}៖</span>
                <span class="block font-bold text-6xl text-red-500">{{ $this->followups }}</span>
    ...
    <div
        class="relative mt-12 border border-zinc-200 px-4 pb-4 pt-8 rounded-xl shadow grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8">
        <div class="absolute -top-4 left-4 backdrop-blur-lg px-2 py-1 text-xl text-zinc-500 font-semibold">
        ...
        <div class="relative bg-amber-100/80 border border-amber-300 rounded-lg h-36 overflow-clip p-4">
            ...
            <div>
                <span class="block font-semibold text-lg">{{ __('Pending Documents') }}៖</span>
                <span class="block font-bold text-6xl text-amber-600">{{ $this->beDocs }}</span>
                <flux:link href="{{ route('admin.be-document.pending') }}" variant="subtle" class="text-sm"
                    wire:navigate>
                    {{ __('View Documents') }}</flux:link>
            </div>
        </div>
        <div class="relative bg-red-100/80 border border-red-300 rounded-lg h-36 overflow-clip p-4">
            ...
            <div>
                <span class="block font-semibold text-lg">{{ __('Follow Up Documents') }}៖</span>
                <span class="block font-bold text-6xl text-red-500">{{ $this->beFollowups }}</span>
